...
const OrdenesDetalleVTable = ({
  ...
  const [pedidosDetalleEstatusV, setPedidosDetalleEstatusV] = useState([]);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setOrdenesDetalleData(selectedOrdenesData.pedidos_detalle_ps_estatus_v); //Se ponen los datos en el useState pero solo los del subdocumento info_ad
