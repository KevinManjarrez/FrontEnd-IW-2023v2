...
export const OrdenesDetallesFValues = (values, ordenesDetallesF,index) => {
  ...
  OrdenesDetallesF.ordenes_detalle[index].pedidos_detalle_ps_estatus_f.push(nuevoDetalleF);
